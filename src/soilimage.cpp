...
SoilImage::SoilImage(): SoilWidget(IMAGE)
{
    ...
    view_min_size.w = ABSOLUTE_VIEW_MIN_SIZE.w + 80;
    view_min_size.h = ABSOLUTE_VIEW_MIN_SIZE.h + 80;
...
void SoilImage::set_alignment_x(ALIGNMENT a)
{
...
void SoilImage::set_alignment_y(ALIGNMENT a)
{
...
//---------------------------------------------- SOILOBJECT CALLBACK
int SoilImage::soilobject_callback(int arg)
{
