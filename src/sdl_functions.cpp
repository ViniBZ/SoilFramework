...
//-------------------------------------------------------------- INIT WINDOW
SDL_Window* sdl_init_window(int w, int h,int x,int y)
{
    //Initialize SDL
    ...
    //Create window
    int window_init_pos_x = SDL_WINDOWPOS_UNDEFINED;
    int window_init_pos_y = SDL_WINDOWPOS_UNDEFINED;
    if(x >= 0){window_init_pos_x = x;}
    if(y >= 0){window_init_pos_y = y;}
    SDL_Window* window = SDL_CreateWindow( "WINDOW TITLE", window_init_pos_x, window_init_pos_y, w, h, SDL_WINDOW_HIDDEN);
    if( window == NULL )
    {
...
//-------------------------------------------------------------- INIT SDL
SDL_GUI_PT sdl_init(int w,int h,int x,int y)
{
    SDL_GUI_PT res;
    res.sdl_window=NULL;
    ...
    //WINDOW
    res.sdl_window=sdl_init_window(w,h,x,y);
