...
void SoilUIElm::validate_for_execution()
{
    ...
    {
        //printf("\n\nSoilUIElm::HERE 3");
        //printf("\nview size w :%d", view_size.w);
        //printf("\nview size h :%d", view_size.h);
        //printf("\nview min size w :%d", view_min_size.w);
        //printf("\nview min size h :%d", view_min_size.h);
        //printf("\nview max size w :%d", view_max_size.w);
        //printf("\nview max size h :%d", view_max_size.h);
    }
