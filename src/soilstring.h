...
private:
    ...
    bool signal_change;//if it signals its SoilObject receiver[0] callback
...
public:
    ...
    int search_str(const SoilString& str, int pos, int n, bool match_case, bool match_accent, bool left_to_right) const;//return sub_str pos
    int search_str(const SoilString& str, int pos, bool match_case, bool match_accent, bool left_to_right) const;//return sub_str pos
    int search_str(const SoilString& str, int pos, bool match_case, bool match_accent) const;//return sub_str pos
    int search_str(const char* str, int pos, int n, bool match_case, bool match_accent, bool left_to_right) const;//return sub_str pos
    int search_str(const char* str, int pos, bool match_case, bool match_accent, bool left_to_right) const;//return sub_str pos
