...
public:
    ...
    //------------------------- SoilTextWidget TextField VARIABLES
    ...
    bool line_ruler_active;
    SOIL_RECT line_ruler_rect;
    ...
    int get_line_n();
    int get_font_size();
    void set_ruler_pack(int* line_n, int* font_s);
    ...
    int text_widget_changed(int arg);
    //----------------------------- EVENTS
    ...
    virtual POINT move_content_view_virt(int mx, int my);//
